...
public class StatAllocator {
    ...
    private static int remainingPoints = TOTAL_POINTS;

    public static int allocate(String statName, int min, int max) {
        while (true) {
            ...
            try {
                ...
                // do nothing, will go to error message
            }
            System.out.println("Valor inválido o puntos insuficientes. Intenta de nuevo.");
        }
    }

    public static int allocateRemaining(String statName, int min, int max) {
